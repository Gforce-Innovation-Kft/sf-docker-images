...
| Tag | Moves? | Points at |
|-----|--------|-----------|
| `1.6.1` | **immutable** | one exact release — pin this in production |
| `latest` | moving | most recent release |

Pin an immutable tag (`gforceinnovation/sf-ci:1.6.1`) for reproducible pipelines; track
...
pushed git tag (see [`.github/workflows/build-and-push.yml`](.github/workflows/build-and-push.yml)).
